full_list = {
    'Programs': {
        'Android Debug Bridge':          ['https://4pda.to/forum/index.php?showtopic=383300', 'https://adbinstaller.com/', 'i > b'],
        'Archivators':                   {
            '7-Zip':                     ['https://www.7-zip.org', '', '.NewsText', 1],
                                         #['https://1progs.ru/7-zip/', 'https://www.7-zip.org', '.entry-title', 1],
            'UltraISO':                  ['http://www.ezbsystems.com/ultraiso/download.htm', 'https://rsload.net/soft/cleaner-disk/8714-ultraiso.html', 'tr + tr + tr tr + tr + tr + tr + tr tr + tr td + td', True],
        ...
        'Browsers':                      {
            ...
            'Microsoft Edge':            ['https://www.whatismybrowser.com/guides/the-latest-version/edge', 'https://www.microsoft.com/en-us/edge', 'td + td'],
        ...
        'Cisco Packet Tracer':           ['https://www.packettracernetwork.com/download/download-packet-tracer.html', '', 'h1', 4],
        'Cloud Storage':                 {
            'Google Drive':              ['https://support.google.com/a/answer/7577057?hl=en', 'https://www.google.ru/drive/download/', 'h2 ~ p', -1],
            'TeraBox':                   ['https://www.terabox.com/terabox-cloud-storage-for-pc-free-download', '', 'body > script', 13, 14, -1, ','],
            'Yandex Disk':               ['https://ru.freedownloadmanager.org/Windows-PC/Yandex-Disk-FREE.html', 'https://disk.yandex.ru/promo/download', '.quick_specs div + div + div + div span+span']},
        'Code Editors':                  {
        ...
        'Download Managers':             {
            'Internet Download Manager': ['https://www.internetdownloadmanager.com/news.html', 'https://rsload.net/soft/manager/8294-internet-download-manager.html', '.col-center > h3', True, 4],
        ...
        'Movavi Screen Recorder':        ['https://1progs.ru/movavi-screen-recorder-aktivaciya-klyuch/', '', '.entry-title', 3],
        'Music editors':                 {
            'Avid Sibelius':             ['https://1progs.ru/avid-sibelius/', '', '.entry-title', True, 2],
            'MuseScore':                 ['https://musescore.org/ru/download', '', 'strong', 5, '', '', '', {
                'MuseScore Downloader':  ['https://github.com/Xmader/musescore-downloader/releases', '', '.ml-1.wb-break-all', 0, 1, '', '', {
                    'NodeJS':            ['https://nodejs.org/en/download/current/', '', 'strong']}]}],
        ...
        'Torrent Clients':               {
            ...
            'µTorrent':                  ['https://www.utorrent.com/downloads/win/', '', '.ml0', 1]},
        'Video Editors':                 {
        ...
        'VPN':                           {
            ...
            'Windscribe':                ['https://windscribe.com/changelog/windows', 'https://windscribe.com/install/desktop/windows', '.release > h3 > a', '', 1]},
        'Компас 3D':                     ['https://1progs.ru/kompas-3d-polnaya-versiya-klyuch-11/', '', '.entry-title', 2]
    },

    'Games': {
        'Assassin\'s Creed':                               {
            'Assassin\'s Creed':   ['https://byrut.org/5460-assassins-creed-directors-cut-edition-pcs.html', '', '.subhname', 1],
            'Assassin\'s Creed 2':          ['https://byrut.org/4232-assassins-creed-2-deluxe-edition-pc.html', '', '.subhname', 1],
            ...
            'Assassin\'s Creed 3 + Liberation': ['https://byrut.org/2856-assassins-creed-iii-remastered-repack-by-xatab.html', '', '.subhname', 1]},
        'The Sims 4':                                      ['https://byrut.org/608-sims-4-repack-by-xatab-to.html', '', '.subhname', 1],
        'Warframe':                                        ['https://www.warframe.com/ru/updates/pc', 'https://www.warframe.com/download', '.pcVersion', -1]
    },
